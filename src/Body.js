        ...
        return (
            <>
                <div class="container text-bg-secondary inputBody">
                    <ul>
                        <li>
                            <label class="my-1 mr-2 prodCategry">Category : </label> <br />
                        ...
                        <li>
                            <label class="my-1 mr-2 prodPrice">Price Range : </label> <br />
                            <input class="rounded-3 text-center" type="number" id="minPrice" value={minPrice} onChange={this.changeMinPrice} aria-describedby="minPrice"
                                placeholder="Min Price" required /> <br />
                            <br /> <input class="rounded-3 text-center" type="number" id="maxPrice" value={maxPrice} onChange={this.changeMaxPrice} aria-describedby="maxPrice"
                                placeholder="Max Price" required />
                        </li>
                        <li>
                            <button class="btn btn-outline-primary border border-2" id="btnFilter" onClick={this.filterProduct} >
                                Filter
                            </button>
                        </li>
                    </ul>
